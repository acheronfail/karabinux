...
impl FromKBKeyCode for Key {
    fn from_kb_key_code(key_code: &str) -> Option<Key> {
        match key_code {
            ...
            "left_command" => Some(Key::KeyLeftMeta),
            "right_control" => Some(Key::KeyRightCtrl),
            "right_shift" => Some(Key::KeyRightShift),
            "right_option" => Some(Key::KeyRightAlt),
            "right_command" => Some(Key::KeyRightMeta),
            "fn" => Some(Key::KeyFn),
            ...
            "f23" => Some(Key::KeyF23),
            "f24" => Some(Key::KeyF24),
            // "display_brightness_decrement" => Some(Key::Key),
            // "display_brightness_increment" => Some(Key::Key),
            // "mission_control" => Some(Key::Key),
            // "launchpad" => Some(Key::Key),
            // "dashboard" => Some(Key::Key),
            // "illumination_decrement" => Some(Key::Key),
            // "illumination_increment" => Some(Key::Key),
            // "rewind" => Some(Key::Key),
            // "play_or_pause" => Some(Key::Key),
            // "fastforward" => Some(Key::Key),
            // "mute" => Some(Key::Key),
            // "volume_decrement" => Some(Key::Key),
            // "volume_increment" => Some(Key::Key),
            // "eject" => Some(Key::Key),
            ...
            // "keypad_num_lock" => Some(Key::Key),
            // "keypad_slash" => Some(Key::Key),
            // "keypad_asterisk" => Some(Key::Key),
            // "keypad_hyphen" => Some(Key::Key),
            // "keypad_plus" => Some(Key::Key),
            // "keypad_enter" => Some(Key::Key),
            // "keypad_1" => Some(Key::Key),
            // "keypad_2" => Some(Key::Key),
            // "keypad_3" => Some(Key::Key),
            // "keypad_4" => Some(Key::Key),
            // "keypad_5" => Some(Key::Key),
            // "keypad_6" => Some(Key::Key),
            // "keypad_7" => Some(Key::Key),
            // "keypad_8" => Some(Key::Key),
            // "keypad_9" => Some(Key::Key),
            // "keypad_0" => Some(Key::Key),
            // "keypad_period" => Some(Key::Key),
            // "keypad_equal_sign" => Some(Key::Key),
            // "keypad_comma" => Some(Key::Key),
            // "vk_none" => Some(Key::Key),
            // "print_screen" => Some(Key::Key),
            // "scroll_lock" => Some(Key::Key),
            // "pause" => Some(Key::Key),
            // "insert" => Some(Key::Key),
            ...
            // "ex_sel" => Some(Key::Key),
            // "left_alt" => Some(Key::Key),
            // "left_gui" => Some(Key::Key),
            // "right_alt" => Some(Key::Key),
            // "right_gui" => Some(Key::Key),
